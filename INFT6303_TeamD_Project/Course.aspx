...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="DropDownList2" ErrorMessage="* Department should not be empty" ForeColor="Red" InitialValue="select a department" SetFocusOnError="True"></asp:RequiredFieldValidator>
                <br />
                <br />
            </td>
        </tr>
